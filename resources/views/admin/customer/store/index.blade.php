        ...
        <div class="max-w-12xl mx-auto sm:px-6 lg:px-12 ms-0">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="d-flex justify-content-end mb-4">
                    <a href="{{ route('admin.store.create') }}" class="btn btn-primary shadow">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center d-flex justify-content-center">
                                    <a href="{{ route('admin.store.edit', $member->id) }}" class="btn btn-warning btn-sm me-1 shadow-sm">
                                        <i class="bi bi-pencil-square"></i> Edit
                                    </a>
                                    <form action="{{ route('admin.store.destroy', $member->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this member?')">
                                        @csrf
                                        @method('DELETE')
