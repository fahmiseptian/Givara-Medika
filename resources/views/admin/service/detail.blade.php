        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    {{-- Assume $serviceContent is an instance of serviceContent model to be edited --}}
                    <form action="{{ route('admin.service.updateContent', $serviceContent->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                value="{{ old('title', $serviceContent->title) }}" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="content" rows="5"
                                class="summernote mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">{{ old('content', $serviceContent->content) }}</textarea>
                            @error('content')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2">
                                <img src="{{ $serviceContent->banner_url }}" alt="Banner Saat Ini" class="h-24 rounded">
                            </div>
                            @endif
                            @error('banner')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
