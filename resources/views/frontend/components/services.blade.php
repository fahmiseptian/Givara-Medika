        ...
        <div class="grid grid-cols-12 gap-8 mb-10">
            ...
            <div class="col-span-12 lg:col-span-6 lg:pl-6">
                <p class="text-sm lg:text-base leading-relaxed text-slate-700">
                    {!! $servicePage->content ??
                        'Lorem ipsum dolor sit amet consectetur, quis integer egestas neque amet massa et parturient. Lorem ipsum dolor sit amet consectetur. Mattis quis integer egestas.' !!}
                </p>
            </div>
        </div>
            ...
            @foreach ($services as $s)
                <article
                    ...
                    <div class="flex flex-1 flex-col p-4">
                        ...
                        <div class="mt-4 pt-1">
                            <a href="https://wa.me/{{ $setting->wa_number }}?text={{ $setting->text_wa }}"
                                target="_blank" rel="noopener"
                                class="inline-flex items-center rounded-full bg-red-accent px-4 py-2 text-xs font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500">
                                Get Service
                            </a>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div class="flex justify-center">
                @if (isset($serviceContent->banner_url))
                    <img src="{{ $serviceContent->banner_url }}" alt="Service Image"
                        class="rounded-lg shadow-md object-cover w-full max-w-md">
                @else
                    <img src="{{ asset('images/room.jpg') }}" alt="Service Image"
                        class="rounded-lg shadow-md object-cover w-full max-w-md">
                @endif
            </div>
